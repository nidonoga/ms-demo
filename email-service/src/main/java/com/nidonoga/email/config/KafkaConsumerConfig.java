package com.nidonoga.email.config;
...
public class KafkaConsumerConfig {
    ...
    ConsumerFactory<String, EmailDto> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "ms-email-kafka-group-id");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(EmailDto.class, false));
    }
